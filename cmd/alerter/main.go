...
import (
	...
	"github.com/GoogleCloudPlatform/testgrid/pkg/alerter"
	alertLogger "github.com/GoogleCloudPlatform/testgrid/pkg/alerter/log"
)
...
func main() {
	...
	updateOnce := func(ctx context.Context) error {
		...
		defer cancel()
		return alerter.Update(ctx, client, opt.config, opt.concurrency, opt.dashboard, []alerter.Klaxon{alertLogger.AlertToLog{}}, opt.confirm)
	}
